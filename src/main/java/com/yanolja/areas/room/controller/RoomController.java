...
public class RoomController {
    ...
    public ApiResponse<Void> addRoomOptions(
        ...
        return ApiResponse.success("객실 옵션 추가 성공");
    }
    ...
    public ApiResponse<Void> removeRoomOption(
        ...
        return ApiResponse.success("객실 옵션 제거 성공");
    }
    ...
    public ApiResponse<Void> removeAllRoomOptions(@PathVariable Long roomId) {
        ...
        return ApiResponse.success("객실 모든 옵션 제거 성공");
    }
    ...
    public ApiResponse<List<RoomDto.ListResponse>> getRoomsWithAllOptions(
        ...
        return ApiResponse.success(responses, "모든 옵션을 가진 객실 목록 조회 성공");
    }
    ...
    public ApiResponse<List<RoomDto.ListResponse>> getRoomsWithAnyOptions(
        ...
        return ApiResponse.success(responses, "옵션 중 하나 이상을 가진 객실 목록 조회 성공");
    }
    ...
    public ApiResponse<List<RoomDto.ListResponse>> getRoomsByAccommodationWithOptions(
        ...
        return ApiResponse.success(responses, "숙소별 옵션 매핑된 객실 목록 조회 성공");
    }
    ...
    public ApiResponse<List<Object[]>> getOptionUsageStatistics() {
        ...
        return ApiResponse.success(statistics, "옵션별 사용 통계 조회 성공");
    }
    ...
    public ApiResponse<List<Object[]>> getRoomOptionCountStatistics() {
        ...
        return ApiResponse.success(statistics, "객실별 옵션 개수 통계 조회 성공");
    }
} 